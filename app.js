...
for (let i = 0; i < wordsArray.length; i++) {
    if (wordsArray[i] === wordt) {
        cnt++;
    }
}
document.write("<br><br>Text: " + sentence + "<br>There are " + cnt + " occurence(s) of '" + wordt + "'")